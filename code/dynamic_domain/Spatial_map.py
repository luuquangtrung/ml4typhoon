...
parser = ArgumentParser(description="Plot spatial map")
...
fig.tight_layout()
plt.savefig(os.path.join(out, 'fig.eps'), bbox_inches='tight', format='eps')
plt.savefig(os.path.join(out, 'fig.pdf'), bbox_inches='tight', format='pdf')
