...
parser.add_argument("--inp_dir", dest="inp_dir", required=True)
parser.add_argument("--out_dir", dest="out_dir", required=True)
parser.add_argument("--weight", dest="weight", default=0)
parser.add_argument("--map_path", dest="map_path", required=True)
